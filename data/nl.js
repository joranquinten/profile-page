...
const about = {
  ...
  bio:
    "<p>Ik ben een webdeveloper in hart en nieren! Ik heb een brede interesse op het gebied van webontwikkeling en ik werk het liefst in een team waar ik snel concepten vertaal naar functionele onderdelen.</p><p>Collega's en mede-ontwikkelaars geven mij inspiratie en maken me enthousiast over de technieken die steeds meer mogelijkheden geven om bezoekers te verrassen, betrekken en betoveren. De eindgebruiker en context stel ik centraal bij het ontwikkelen van oplossingen.</p>  <p>Ik maak geen direct onderscheid tussen backend, frontend of full stack functies.Ik zorgt voor interacties tussen gebruiker en systeem. De manier waarop hangt af van de situatie.</p>",
  quote:
...
const topics = {
  ...
  list: [
    ...
    { name: 'Terminal', level: 'normal', type: 'platforms' },
  ],
};
